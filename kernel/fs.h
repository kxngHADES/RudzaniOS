...
typedef struct fs_node {
	...
	uint32_t inode;     /* Device-specific - allows the FS to identify files */
	...
	struct fs_node *parent; /* The parent directory */
} fs_node_t;
...
extern fs_node_t *bin_dir; /* The root of the filesystem */
...
void mkdir_fs(fs_node_t *node, char *name, uint16_t permission);
void create_fs(fs_node_t *node, char *name, uint16_t permission);
void unlink_fs(fs_node_t *node, char *name);
